      ...
      <Grid container spacing={4}>
          <Grid item xs={12} lg={5} className='border rounded-e-md shadow-md h-[30.5rem] overflow-y-scroll'>
            <div className='p-5 py-7 border-b cursor-pointer'>
              <AddressCard/>
              <Button size='large' variant='contained' sx={{mt:2, backgroundColor:'RGB(145,85,253)'}}>
                Delivery here
              </Button>
            </div>
              ...
              <Box className='border rounded-s-md shadow-md p-5'>
                  <form onSubmit={handleSubmit}>
                    <Grid container spacing={3}>
                      ...
                      <Grid item xs={12} sm={6}>
                          <TextField type='number' required id='zip' name='zip' label='Zip/Postal Code' fullWidth autoComplete='shipping postal-code'/>
                      </Grid>

                      <Grid item xs={12} sm={6}>
                          <TextField type='number' max={10} required id='phoneNumber' name='phoneNumber' label='Phone Number' fullWidth autoComplete='given-name'/>
                      </Grid>

                      <Grid item xs={12}>
                        <Button type='submit' size='large' variant='contained' sx={{py:1, mt:2, backgroundColor:'RGB(145,85,253)'}}>
                          Deliver here
                        </Button>
                      </Grid>
